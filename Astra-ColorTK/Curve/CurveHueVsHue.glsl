...
float graphEvalWrap(float graph_x, CurveHueVsHue gp)
{
...
struct CurveHueVsHue {
	sampler2D sampler;

	//@ label: "mix_CurveHueVsHue", editor: range, min: 0, max: 1, range_min: 0, range_max: 1, range_default: 1
	float mix;
...
vec4 texture( CurveHueVsHue s, vec2 tex_coords )
{
	//input
