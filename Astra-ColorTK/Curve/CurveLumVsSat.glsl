...
float graphEval(float graph_x, CurveLumVsSat gp)
{
...
struct CurveLumVsSat {
	sampler2D sampler;

	//@ label: "mix_CurveLumVsSat", editor: range, min: 0, max: 1, range_min: 0, range_max: 1, range_default: 1
	float mix;
...
vec4 texture( CurveLumVsSat s, vec2 tex_coords )
{
	//input
