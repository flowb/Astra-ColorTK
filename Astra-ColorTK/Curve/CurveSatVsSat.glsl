...
float graphEval(float graph_x, CurveSatVsSat gp)
{
...
struct CurveSatVsSat {
	sampler2D sampler;

	//@ label: "mix_CurveSatVsSat", editor: range, min: 0, max: 1, range_min: 0, range_max: 1, range_default: 1
	float mix;
...
vec4 texture( CurveSatVsSat s, vec2 tex_coords )
{
	//input
