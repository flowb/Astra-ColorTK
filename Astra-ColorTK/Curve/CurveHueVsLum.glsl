...
float graphEvalWrap(float graph_x, CurveHueVsLum gp)
{
...
struct CurveHueVsLum {
	sampler2D sampler;

	//@ label: "mix_CurveHueVsLum", editor: range, min: 0, max: 1, range_min: 0, range_max: 1, range_default: 1
	float mix;
...
vec4 texture( CurveHueVsLum s, vec2 tex_coords )
{
	//input
